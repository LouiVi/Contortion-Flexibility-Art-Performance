...
function Home( path, layContent )
{
    ...
    //Add a logo.
	var img = app.CreateVideoView( 1, 0.5,"Controls" );
	img.SetFile( "Misc/Contortion Flexibility Art Performance.mp4");
	//Misc/Bienvenidos - Me Rindo-[zipza.com].mp4" );
	img.Play();
	//img.
	lay.AddChild( img );
...
function File( path, layContent )
{
    ...
    var btnHelp = CreateHelpButton( layHoriz, "image" );
...
{
    var btnHelp = app.CreateButton( "[fa-question]", -1, 0.1, "FontAwesome" );
    btnHelp.help = id;
