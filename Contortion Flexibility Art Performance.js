...
var appPath = "/sdcard/Contortion Flexibility Art Performance";
var curMenu = "Contortion Flexibility Art Performance";
var curPage = null;

function MergeScripts(scrArray)
{
	var s = "";
	for(c=0;c<scrArray.length;c++){
		s+= "\r\n" + app.ReadFile( app.GetAppPath()+"/"+ scrArray[c]);
	}
	app.WriteFile( app.GetAppPath()+"/All.js", s, "Write" );
}
...
//MergeScripts(["Home.js", "About.js", "File.js", "Utils.js"]);
...
function CreateActionBar()
{
    ...
    txtBarTitle.SetMargins(0,16,0,0,"dip");
    txtBarTitle.SetTextSize( 14 );
...
function CreateDrawer()
{
	...
	var img = app.CreateImage( "Img/Contortion Flexibility Art Performance.png", 0.315 );
    ...
    var listItems = app.GetAppName()+"::[fa-home],About::[fa-question-circle],New File::[fa-plus]";
    ...
    lstMenuMain.SetItemByIndex( 0, app.GetAppName() );
...
function lstMenu_OnTouch( title, body, type, index )
{
    ...
    //Handle page changes.
    curMenu = title;
    if( title==app.GetAppName()) ChangePage( home, title );
